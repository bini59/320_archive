...
const CONTENT_HEADERS = {
  ...
  "Content-Security-Policy": "default-src 'none'; img-src 'self'; base-uri 'none'; form-action 'none'; frame-ancestors 'self'; frame-src 'none'; child-src 'none'; script-src 'none'; style-src 'self'; connect-src 'none'; media-src 'none'; font-src 'self'; object-src 'none'; worker-src 'none'; manifest-src 'none'; sandbox allow-same-origin",
